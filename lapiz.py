...
#--------------------- Variables para el lápiz virtual -------------------------
...
while True:
	...
	cv2.rectangle(frame,(200,0),(250,50),colorBorrador, grosorBorrador)
	...
	_, th = cv2.threshold(imAuxGray,10,255,cv2.THRESH_BINARY) #Umbralizacion -> segmentacion imagen
